...
| **`/create-issues-from-backlog`** | Local feedback `.md` inbox → draft plan → **`gh`** create → clear inbox & append to archive with **GitHub issues** links (see `.cursor/commands/create-issues-from-backlog.md`) |
